#include "task/algorithm/old_alg/bandwidth_info.hh"
...
void BandwidthInfo::set_rdownload(double _rdownload)
{
  rdownload = _rdownload;
  upload[0] = download[0] = rdownload;
  get_bandwith_matrix();
}
